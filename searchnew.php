    ...
    <div class="col-lg-9">
        <div id="pin_dinplay" class="pin">
            <div  class="row">
                <h2>
                    &nbsp;&nbsp;
                    <b color="blue">Here is your search result</b>
                </h2>
            </div>
            <ul>
                <?php
                ...
                if($_GET['country']!="") {
                    ...
                    if(($_GET['description']!="") || ($_GET['category']!="") )
                    {
                ...
                if($_GET['cost']!= "") {
                    $cost= $_GET['cost'];
                    if(($_GET['description']!="") || ($_GET['category']!="") || ($_GET['country']!=""))
                    {
                ...
                $PIN_SQL= $PIN_SQL . " and user_id != '$current_user_id' order by pin_id desc";
